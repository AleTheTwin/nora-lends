...
-- AddForeignKey
ALTER TABLE "Nota" ADD CONSTRAINT "Nota_eventoId_fkey" FOREIGN KEY ("eventoId") REFERENCES "Evento"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Evento" ADD CONSTRAINT "Evento_autorId_fkey" FOREIGN KEY ("autorId") REFERENCES "Persona"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
